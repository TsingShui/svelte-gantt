        ...
        tasks: [
            {
                "id": 1,
                "resourceId": 13,
                "label": "Normal Task (can move horizontally)",
                "from": time("9:00"),
                "to": time("11:00"),
                "classes": "blue",
                "draggable": true
            },
            {
                "id": 2,
                "resourceId": 12,
                "label": "Vertical Only Task (horizontal locked)",
                "from": time("10:00"),
                "to": time("12:00"),
                "classes": "green",
                "draggable": true,
            ...
            },
            {
                "id": 3,
                "resourceId": 11,
                "label": "Another Vertical Only Task",
                "from": time("13:00"),
                "to": time("15:00"),
                "classes": "orange",
                "draggable": true,
...
<svelte:head>
    <title>Vertical Only Movement - svelte-gantt</title> 
</svelte:head>

<div class="info">
    <h3>Vertical Only Movement Demo</h3>
    <p>This demo shows tasks with the <code>verticalOnly</code> property set to <code>true</code>.</p>
    <ul>
        <li><strong>Blue tasks</strong>: Normal tasks that can move both horizontally and vertically</li>
        <li><strong>Green/Orange tasks</strong>: Vertical-only tasks that can only move between rows but maintain their time position</li>
    </ul>
    <p>Try dragging the tasks to see the difference in behavior!</p>
</div>
